...
namespace Zooline.Controllers
{
    public class EspeciesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,NombreCientifico,Estatura,Ancho,descripcion,Reino")] Especie especie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,NombreCientifico,Estatura,Ancho,descripcion,Reino")] Especie especie)
        {
            if (id != especie.Id)
            {
                return NotFound();
